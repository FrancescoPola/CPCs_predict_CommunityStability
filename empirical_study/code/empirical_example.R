...
load(here("empirical_study", "data", "dens_biomass_mono.RData"))
names(dens)
...
info_communities <- read_csv(here("empirical_study", "data", "info_communities.csv"))
...
# read complete_aggr
empirical_results <- read.csv(here("empirical_study", "data", "empirical_results.csv"))
...
write.csv(
  empirical_results_summary_stats,
  here("empirical_study", "data", "empirical_results_summary.csv"),
  row.names = FALSE,
  quote = FALSE
)
