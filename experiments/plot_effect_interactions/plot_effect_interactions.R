...
# Sys.setenv(GITHUB_PAT = "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")
...
experiment_folder_location <- "~/Desktop/Community_simulations/experiments"
...
create_experiment_table_mod(experiment_folder, experiment_design_filename)
...
## Simulate dynamics
simulate_dynamics_mod(experiment_folder, experiment_design_filename)
...
saveRDS(community_measures, paste0(experiment_folder, "community_measures_new.RDS"))
